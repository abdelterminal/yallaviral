            ...
            <Table>
                <TableHeader>
                    <TableRow className="border-border hover:bg-muted/50">
                        ...
                        <TableHead className="text-foreground">Rate/Price</TableHead>
                        <TableHead className="text-right text-foreground">Actions</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {resources.map((resource) => (
                        <TableRow key={resource.id} className="border-border hover:bg-muted/50">
                            <TableCell>
                            ...
                            <TableCell>
                                <Badge variant="secondary" className="bg-muted text-foreground hover:bg-muted capitalize">
                                    {resource.type}
                                </Badge>
                            </TableCell>
