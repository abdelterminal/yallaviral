        ...
        <footer className="w-full bg-card pt-20 pb-8 relative overflow-hidden text-foreground border-t border-border">
            ...
            <div className="container px-4 md:px-6 mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    {/* Column 2: Platform */}
                    <div>
                        <h4 className="text-xs font-black uppercase tracking-widest text-foreground mb-6">{t('footerPlatform')}</h4>
                    ...
                    {/* Column 3: Company */}
                    <div>
                        <h4 className="text-xs font-black uppercase tracking-widest text-foreground mb-6">{t('footerCompany')}</h4>
                        <ul className="space-y-3">
                    ...
                    {/* Column 4: Contact */}
                    <div>
                        <h4 className="text-xs font-black uppercase tracking-widest text-foreground mb-6">{t('footerContact')}</h4>
                        <ul className="space-y-3">
