                ...
                <div className="flex items-center justify-between px-5 py-4 bg-muted/30">
                    ...
                    {unreadCount > 0 && (
                        <Button
                            variant="ghost"
                            size="sm"
                            className="h-8 px-3 text-xs font-bold text-primary hover:text-foreground hover:bg-primary/20 transition-all rounded-full"
                    ...
                    {notifications.length === 0 ? (
                        ...
                        notifications.map((n) => (
                            ...
                            >
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <div className={cn( "h-2 w-2 rounded-full shrink-0",
                                            n.type === "success" ? "bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" :
                                                n.type === "warning" ? "bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]" : "bg-primary shadow-[0_0_8px_rgba(124,58,237,0.5)]"
                                        )} />
                                        <span className={cn("font-bold text-[15px] tracking-tight", !n.read ? "text-foreground" : "text-muted-foreground/80")}>
                                            {n.title}
                                        </span>
                                    </div>
                                ...
                                <p className={cn( "text-sm leading-relaxed line-clamp-2 pl-4.5 transition-colors",
