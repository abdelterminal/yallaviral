...
export default async function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0B0E17] flex flex-col items-center justify-center text-white font-sans selection:bg-primary/30 selection:text-white relative p-6 overflow-hidden">
            ...
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-primary/20 rounded-full blur-[120px] animate-pulse pointer-events-none" />
            <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-violet-500/10 rounded-full blur-[120px] animate-pulse pointer-events-none" style={{ animationDelay: '1s' }} />
